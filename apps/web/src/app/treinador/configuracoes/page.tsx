...
import { createStudioClosure, useStudioMock } from '@/lib/mock-api';
...
export default function TreinadorConfiguracoesPage() {
  ...
  const list = closures.slice().sort((left, right) => right.startsOn.localeCompare(left.startsOn));
