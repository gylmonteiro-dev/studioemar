...
import {
  ...
  regularSlotSelectionSchema,
  resetPasswordRequestSchema,
  studentRegularSlotSchema,
  studioClosureSchema,
  studioHourSchema,
  timeSlotSchema,
...
const OPENAPI_PATHS = [
  ...
  '/plans/{id}',
  '/students',
  '/students/regular-availability',
  '/students/{id}',
  '/students/{id}/bookings',
  '/students/{id}/credits',
  '/students/{id}/trainers',
  '/operators',
  '/operators/{id}',
  '/class-types',
  '/studio-hours',
...
const SCHEMA_MAP: Record<string, z.ZodTypeAny> = {
  ...
  RegularSlotSelection: regularSlotSelectionSchema,
  StudentRegularSlot: studentRegularSlotSchema,
  RegularAvailabilitySlot: regularAvailabilitySlotSchema,
  UpdateStudentTrainersRequest: updateStudentTrainersRequestSchema,
  UpdateStudentRequest: updateStudentRequestSchema,
  CreateOperatorRequest: createOperatorRequestSchema,
  UpdateOperatorRequest: updateOperatorRequestSchema,
  User: userSchema,
  Booking: bookingSchema,
  CreateBookingRequest: createBookingRequestSchema,
  CancelTimeSlotRequest: cancelTimeSlotRequestSchema,
  Cancellation: cancellationSchema,
  Credit: creditSchema,
  CreateStudioHourRequest: createStudioHourRequestSchema,
  CreateTimeSlotRequest: createTimeSlotRequestSchema,
  CreateClassTypeRequest: createClassTypeRequestSchema,
  ClassType: classTypeSchema,
  Plan: planSchema,
  CreatePlanRequest: createPlanRequestSchema,
  UpdatePlanRequest: updatePlanRequestSchema,
  StudioHour: studioHourSchema,
